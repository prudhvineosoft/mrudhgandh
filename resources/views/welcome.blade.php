                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Eco Friendly Products </h3>
                                    <a href="{{route('product-index')}}" class="btn btn-light py-2 px-3">Shop Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <h1 class="mb-4 font-weight-semi-bold">Festive Collection</h1>
                        <a href="{{route('product-by-category',['slug'=>'festive-lamps'])}}" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">10% off the all order</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Decorative Collection</h1>
                        <a href="{{route('product-by-category',['slug'=>'decorative'])}}" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
